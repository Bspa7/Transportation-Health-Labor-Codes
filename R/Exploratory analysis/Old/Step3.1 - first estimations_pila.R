...
#pila_est <- sample_frac(pila_est, 0.01)
...
run_estimations(pila_est, "asalariado", "cutoff30", "pila30_asalariado")
...
list_est_pila30 <- list(
  pila30_genero, pila30_estrato1, pila30_estrato2, pila30_edad, pila30_registros, 
  pila30_ibc_salud, pila30_sal_dias_cot, pila30_asalariado
)
list_est_pila40 <- list(
  pila40_genero, pila40_estrato1, pila40_estrato2, pila40_edad, pila40_registros, 
...
write_parquet(est_pila30, file.path(output_folder, "parquet/20240607-est_pila30.parquet"))
write_parquet(est_pila40, file.path(output_folder, "parquet/20240607-est_pila40.parquet"))


estimaciones_list_objects <- c(
  "pila30_genero", "pila30_estrato1", "pila30_estrato2", "pila30_edad",
  "pila30_asalariado", "pila30_registros", "pila30_ibc_salud", "pila30_sal_dias_cot",
  "pila40_genero", "pila40_estrato1", "pila40_estrato2", "pila40_edad",
  "pila40_asalariado", "pila40_registros", "pila40_ibc_salud", "pila40_sal_dias_cot"
)
