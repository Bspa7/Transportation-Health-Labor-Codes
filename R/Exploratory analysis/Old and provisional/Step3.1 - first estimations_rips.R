...
#rips_est <- sample_frac(rips_est, 0.01)
#ensayo <-  rdrobust(rips_est$genero, rips_est$cutoff30, all=TRUE)  
#summary(ensayo)  
...
list_est_rips30 <- list(
  rips30_genero, rips30_estrato1, rips30_estrato2, rips30_edad, rips30_visitas, 
...
list_est_rips40 <- list(
  rips40_genero, rips40_estrato1, rips40_estrato2, rips40_edad, rips40_visitas, 
...
write_parquet(est_rips30, file.path(output_folder, "parquet/20240607-est_rips30.parquet"))
write_parquet(est_rips40, file.path(output_folder, "parquet/20240607-est_rips40.parquet"))
