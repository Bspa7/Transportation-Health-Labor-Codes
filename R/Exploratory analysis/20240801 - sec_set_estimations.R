...
# Unir todas las estimaciones en un solo dataframe
list_est <- mget(ls(pattern = "^est(2535|2040|3545|3050)_"))
est_cut <- bind_rows(list_est)

# Guardar el dataframe unido en formato .parquet
write_parquet(est_cut, file.path(output_folder, "parquet/20240801-table_est_v2.parquet"))

# Limpiar los objetos de las estimaciones
