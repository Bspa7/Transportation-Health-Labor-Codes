...
write_parquet(estadisticas_income_anual,   file.path(output_folder, "parquet/20240930-stats_set5_income_y.parquet"))
write_parquet(estadisticas_income_mensual, file.path(output_folder, "parquet/20240930-stats_set5_income_m.parquet"))
write_parquet(results_continuous_yearly,   file.path(output_folder, "parquet/20240930-stats_set5_cont_y.parquet"))
write_parquet(results_continuous_monthly,  file.path(output_folder, "parquet/20240930-stats_set5_cont_m.parquet"))
write_parquet(results_count_yearly,        file.path(output_folder, "parquet/20240930-stats_set5_count_y.parquet"))
write_parquet(results_count_monthly,       file.path(output_folder, "parquet/20240930-stats_set5_count_m.parquet"))
write_parquet(results_unique_monthly,      file.path(output_folder, "parquet/20240930-stats_set5_unique_m.parquet"))


# ----


# SECOND SET OF DESCRIPTIVES ----------------------------------------------------
...
write_parquet(yearly_stats,           file.path(output_folder, "parquet/20240930-stats_set5_step1.parquet"))
write_parquet(results_count_yearly,   file.path(output_folder, "parquet/20240930-stats_set5_step2.parquet"))
...
total_tiene_registro <- main_base %>%
  ...
  summarise(
    ...
    s1520   = n_distinct(personabasicaid[score_1520 == 1]),    
...
write_parquet(total_tiene_registro, file.path(output_folder, "parquet/20240930-stats_set5_step3.parquet"))

# ----


# THIRD SET OF DESCRIPTIVES ----------------------------------------------------
...
write_parquet(yearly_stats,           file.path(output_folder, "parquet/20240930-stats_set5_step4.parquet"))
write_parquet(results_count_yearly,   file.path(output_folder, "parquet/20240930-stats_set5_step5.parquet"))
...
# Mostrar el resultado
write_parquet(total_tiene_registro, file.path(output_folder, "parquet/20240930-stats_set5_step6.parquet"))


# FOURTH SET OF DESCRIPTIVES ----------------------------------------------------
