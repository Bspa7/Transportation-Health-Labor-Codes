...
* Individuals per system and score with at least one register between 2015-2019
	gen n_rips_m1519_s1520 = 12877
	gen n_rips_m1519_s2025 = 23571
	gen n_rips_m1519_s2530 = 40509
	gen n_rips_m1519_s3035 = 27162
	gen n_rips_m1519_s3540 = 28097
	gen n_rips_m1519_s4045 = 33163

	gen n_pila_m1519_s1520 = 12888	
	gen n_pila_m1519_s2025 = 23803
...
global op_s1 "symbol(triangle_hollow) mcolor(purple%50) lpattern(solid) lcol(purple%50)"      		
global op_s2 "symbol(triangle_hollow) mcolor(red%50)    lpattern(dash)       lcol(red%50)"      
global op_s3 "symbol(smx)             mcolor(green%50)  lpattern(solid)      lcol(green%50)"   
global op_s4 "symbol(smcircle)        mcolor(blue%50)   lpattern(vshortdash) lcol(blue%50)"		
...
twoway (connected n_consul_s1520_t15 month if inrange(month, 677, 701), $op_s1 )   ///
       (connected n_consul_s2025_t15 month if inrange(month, 677, 701), $op_s2 )   ///		
       (connected n_consul_s2530_t15 month if inrange(month, 677, 701), $op_s3 )   ///   
       (connected n_consul_s4045_t15 month if inrange(month, 677, 701), $op_s4 ),  /// 
		...
		legend(label(1 "Score 15-20")) ///
		legend(label(2 "Score 20-25")) ///
		legend(label(3 "Score 25-30.56")) ///
		legend(label(4 "Score 40-45")) ///		
...
twoway (connected n_consul_s3035_t15 month if inrange(month, 677, 701), $op_s2 )   ///		
       (connected n_consul_s3540_t15 month if inrange(month, 677, 701), $op_s3 )   ///  
       (connected n_consul_s4045_t15 month if inrange(month, 677, 701), $op_s4 ),  /// 
		xline(686, lpattern(dash_dot) lwidth(vthin) lcolor(black))  ///
        xlabel(#24, labsize(vsmall) grid angle(90)) ///
        ylabel(#10, labsize(small) format(%9.2fc)) ///
...
* Percentage --------------------------------------------------------------------	
twoway (connected d_consul_s1520_t15 month if inrange(month, 677, 701), $op_s1 )   ///
       (connected d_consul_s2025_t15 month if inrange(month, 677, 701), $op_s2 )   ///		
       (connected d_consul_s2530_t15 month if inrange(month, 677, 701), $op_s3 )   ///   
       (connected d_consul_s4045_t15 month if inrange(month, 677, 701), $op_s4 ),  /// 
		xline(686, lpattern(dash_dot) lwidth(vthin) lcolor(black))  ///
        xlabel(#24, labsize(vsmall) grid angle(90)) ///
        ylabel(#10, labsize(small) format(%9.2fc)) ///
        legend(position(6)  col(5)) ///
...
twoway (connected d_consul_s3035_t15 month if inrange(month, 677, 701), $op_s2 )   ///		
       (connected d_consul_s3540_t15 month if inrange(month, 677, 701), $op_s3 )   ///  
       (connected d_consul_s4045_t15 month if inrange(month, 677, 701), $op_s4 ),  /// 
		xline(686, lpattern(dash_dot) lwidth(vthin) lcolor(black))  ///
        xlabel(#24, labsize(vsmall) grid angle(90)) ///
        ylabel(#10, labsize(small) format(%9.2fc)) ///
...
twoway (connected n_proced_s1520_t15 month if inrange(month, 677, 701), $op_s1 )   ///
       (connected n_proced_s2025_t15 month if inrange(month, 677, 701), $op_s2 )   ///		
       (connected n_proced_s2530_t15 month if inrange(month, 677, 701), $op_s3 )   ///   
       (connected n_proced_s4045_t15 month if inrange(month, 677, 701), $op_s4 ),  /// 
		xline(686, lpattern(dash_dot) lwidth(vthin) lcolor(black))  ///
        xlabel(#24, labsize(vsmall) grid angle(90)) ///
        ylabel(#10, labsize(small) format(%9.2fc)) ///
        legend(position(6)  col(5)) ///
...
twoway (connected n_proced_s3035_t15 month if inrange(month, 677, 701), $op_s2 )   ///		
       (connected n_proced_s3540_t15 month if inrange(month, 677, 701), $op_s3 )   ///  
       (connected n_proced_s4045_t15 month if inrange(month, 677, 701), $op_s4 ),  /// 
		xline(686, lpattern(dash_dot) lwidth(vthin) lcolor(black))  ///
        xlabel(#24, labsize(vsmall) grid angle(90)) ///
        ylabel(#10, labsize(small) format(%9.2fc)) ///
...
* Percentage --------------------------------------------------------------------	
twoway (connected d_proced_s1520_t15 month if inrange(month, 677, 701), $op_s1 )   ///
       (connected d_proced_s2025_t15 month if inrange(month, 677, 701), $op_s2 )   ///		
       (connected d_proced_s2530_t15 month if inrange(month, 677, 701), $op_s3 )   ///   
       (connected d_proced_s4045_t15 month if inrange(month, 677, 701), $op_s4 ),  /// 
		xline(686, lpattern(dash_dot) lwidth(vthin) lcolor(black))  ///
        xlabel(#24, labsize(vsmall) grid angle(90)) ///
        ylabel(#10, labsize(small) format(%9.2fc)) ///
        legend(position(6)  col(5)) ///
...
twoway (connected d_proced_s3035_t15 month if inrange(month, 677, 701), $op_s2 )   ///		
       (connected d_proced_s3540_t15 month if inrange(month, 677, 701), $op_s3 )   ///  
       (connected d_proced_s4045_t15 month if inrange(month, 677, 701), $op_s4 ),  /// 
		xline(686, lpattern(dash_dot) lwidth(vthin) lcolor(black))  ///
        xlabel(#24, labsize(vsmall) grid angle(90)) ///
        ylabel(#10, labsize(small) format(%9.2fc)) ///
...
twoway (connected n_emerg_s1520_t15 month if inrange(month, 677, 701), $op_s1 )   ///
       (connected n_emerg_s2025_t15 month if inrange(month, 677, 701), $op_s2 )   ///		
       (connected n_emerg_s2530_t15 month if inrange(month, 677, 701), $op_s3 )   ///   
       (connected n_emerg_s4045_t15 month if inrange(month, 677, 701), $op_s4 ),  /// 
		xline(686, lpattern(dash_dot) lwidth(vthin) lcolor(black))  ///
        xlabel(#24, labsize(vsmall) grid angle(90)) ///
...
twoway (connected n_emerg_s3035_t15 month if inrange(month, 677, 701), $op_s2 )   ///		
       (connected n_emerg_s3540_t15 month if inrange(month, 677, 701), $op_s3 )   ///  
       (connected n_emerg_s4045_t15 month if inrange(month, 677, 701), $op_s4 ),  /// 
		xline(686, lpattern(dash_dot) lwidth(vthin) lcolor(black))  ///
        xlabel(#24, labsize(vsmall) grid angle(90)) ///
        ylabel(#10, labsize(small) format(%9.3fc)) ///
...
* Percentage --------------------------------------------------------------------	
twoway (connected d_emerg_s1520_t15 month if inrange(month, 677, 701), $op_s1 )   ///
       (connected d_emerg_s2025_t15 month if inrange(month, 677, 701), $op_s2 )   ///		
       (connected d_emerg_s2530_t15 month if inrange(month, 677, 701), $op_s3 )   ///   
       (connected d_emerg_s4045_t15 month if inrange(month, 677, 701), $op_s4 ),  /// 
		xline(686, lpattern(dash_dot) lwidth(vthin) lcolor(black))  ///
        xlabel(#24, labsize(vsmall) grid angle(90)) ///
        ylabel(#10, labsize(small) format(%9.3fc)) ///
		ylabel(0(0.01)0.05) ///
...
twoway (connected d_emerg_s3035_t15 month if inrange(month, 677, 701), $op_s2 )   ///		
       (connected d_emerg_s3540_t15 month if inrange(month, 677, 701), $op_s3 )   ///  
       (connected d_emerg_s4045_t15 month if inrange(month, 677, 701), $op_s4 ),  /// 
		xline(686, lpattern(dash_dot) lwidth(vthin) lcolor(black))  ///
        xlabel(#24, labsize(vsmall) grid angle(90)) ///
        ylabel(#10, labsize(small) format(%9.3fc)) ///
...
twoway (connected n_hosp_s1520_t15 month if inrange(month, 677, 701), $op_s1 )   ///
       (connected n_hosp_s2025_t15 month if inrange(month, 677, 701), $op_s2 )   ///		
       (connected n_hosp_s2530_t15 month if inrange(month, 677, 701), $op_s3 )   ///   
       (connected n_hosp_s4045_t15 month if inrange(month, 677, 701), $op_s4 ),  /// 
		xline(686, lpattern(dash_dot) lwidth(vthin) lcolor(black))  ///
        xlabel(#24, labsize(vsmall) grid angle(90)) ///
        ylabel(#10, labsize(small) format(%9.3fc)) ///
		ylabel(0(0.001)0.01) ///
...
twoway (connected n_hosp_s3035_t15 month if inrange(month, 677, 701), $op_s2 )   ///		
       (connected n_hosp_s3540_t15 month if inrange(month, 677, 701), $op_s3 )   ///  
       (connected n_hosp_s4045_t15 month if inrange(month, 677, 701), $op_s4 ),  /// 
		xline(686, lpattern(dash_dot) lwidth(vthin) lcolor(black))  ///
        xlabel(#24, labsize(vsmall) grid angle(90)) ///
        ylabel(#10, labsize(small) format(%9.3fc)) ///
...
* Percentage --------------------------------------------------------------------	
twoway (connected d_hosp_s1520_t15 month if inrange(month, 677, 701), $op_s1 )   ///
       (connected d_hosp_s2025_t15 month if inrange(month, 677, 701), $op_s2 )   ///		
       (connected d_hosp_s2530_t15 month if inrange(month, 677, 701), $op_s3 )   ///   
       (connected d_hosp_s4045_t15 month if inrange(month, 677, 701), $op_s4 ),  /// 
		xline(686, lpattern(dash_dot) lwidth(vthin) lcolor(black))  ///
        xlabel(#24, labsize(vsmall) grid angle(90)) ///
        ylabel(#10, labsize(small) format(%9.3fc)) ///
		ylabel(0(0.001)0.01) ///
...
twoway (connected d_hosp_s3035_t15 month if inrange(month, 677, 701), $op_s2 )   ///		
       (connected d_hosp_s3540_t15 month if inrange(month, 677, 701), $op_s3 )   ///  
       (connected d_hosp_s4045_t15 month if inrange(month, 677, 701), $op_s4 ),  /// 
		xline(686, lpattern(dash_dot) lwidth(vthin) lcolor(black))  ///
        xlabel(#24, labsize(vsmall) grid angle(90)) ///
        ylabel(#10, labsize(small) format(%9.3fc)) ///
